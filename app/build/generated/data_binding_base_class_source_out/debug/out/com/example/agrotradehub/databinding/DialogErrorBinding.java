...
public final class DialogErrorBinding implements ViewBinding {
  ...
  private DialogErrorBinding(@NonNull LinearLayout rootView, @NonNull Button buttonDismiss,
  ...
  public static DialogErrorBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogErrorBinding((LinearLayout) rootView, buttonDismiss, textViewErrorMessage);
    }
