...
public final class ListItemProductosDocsBinding implements ViewBinding {
  @NonNull
  ...
  private ListItemProductosDocsBinding(@NonNull LinearLayout rootView,
      @NonNull TextView fechaDocumento, @NonNull ImageView iconoApoyo,
      @NonNull TextView iddocumento, @NonNull TextView totalDocumento) {
  ...
  @NonNull
  public static ListItemProductosDocsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListItemProductosDocsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_item_productos_docs, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListItemProductosDocsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListItemProductosDocsBinding((LinearLayout) rootView, fechaDocumento, iconoApoyo,
          iddocumento, totalDocumento);
    }
