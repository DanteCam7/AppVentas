...
public final class DialogMessageBinding implements ViewBinding {
  ...
  private DialogMessageBinding(@NonNull LinearLayout rootView, @NonNull TextView textMessage) {
  ...
  public static DialogMessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogMessageBinding((LinearLayout) rootView, textMessage);
    }
