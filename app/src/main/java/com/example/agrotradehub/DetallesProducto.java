...
public class DetallesProducto extends Fragment {
    ...
    int idCliente = 0;
    TextView nombre, link, codigo, precio, precio2, precio3, costo, cantidad, cuantos, ingrediente, unidad, ivatxt, iepstxt, establecerPeecio, sinHistorialActivo;
    ...
    int disponibles;
    int contador = 0;
    Double iva, ieps, precioSelect = 0.0;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        precio2 = view.findViewById(R.id.precio2);
        precio3 = view.findViewById(R.id.precio3);
        establecerPeecio = view.findViewById(R.id.establecerPeecio);
        costo = view.findViewById(R.id.costo);
        cantidad = view.findViewById(R.id.cantidadtxt);
        ...
        cuantos = view.findViewById(R.id.cuantos);
        ...
        precio3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                precio3.setBackgroundColor(0xFF4A235A);
                precio.setBackground(null);
                precio2.setBackground(null);
                establecerPeecio.setBackground(null);
            }
                ...
                if (contador == 0) {
                    ...
                    if (!encontrado){
                        if ((establecerPeecio.getBackground() != null && precio.getBackground() == null) || (establecerPeecio.getBackground() != null && precio.getVisibility() == View.GONE)) {
                            ...
                            if (precio.getBackground() != null && precio2.getBackground() == null && precio3.getBackground() == null) {
                                precioSelect = producto.getPrecios().get(0);
                            } else if (precio.getBackground() == null && precio2.getBackground() != null && precio3.getBackground() == null) {
                                precioSelect = producto.getPrecios().get(1);
                            } else if (precio.getBackground() == null && precio2.getBackground() == null && precio3.getBackground() != null) {
                                precioSelect = producto.getPrecios().get(2);
                            }
                            if (precioSelect != 0 ) {
                                ConfirmarPrecio();
                            } else {
            ...
            public void onResponse(String response) {
                ...
                if (response != null) {
                    ...
                    try {
                        ...
                        cantidad.setText("Disponibles: " + disponibles);
                        ...
                        if (conprecio) {
                            if (datosGlobales.getMoneda().equals("MXN")) {
                                precio.setText("Ultima Venta: $" + precios.get(0).toString());
                                precio2.setText("Penultima Venta: $" + precios.get(1).toString());
                                precio3.setText("Antepenultima Venta: $" + precios.get(2).toString());
                            } else {
                                ...
                                precio.setText("Ultima Venta: $" + formateado);
                                precio2.setText("Penultima Venta: $" + formateado2);
                                precio3.setText("Antepenultima Venta: $" + formateado3);
                            }
                        } else {
    ...
    private void ConfirmarPrecio() {
        ...
        builder.setMessage("Establecer precio: " + formateado).setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                producto.setTotalCarrito(contador);
    ...
    private void establecerNuevoPrecioxProducto() {
        ...
        double precioProducto = producto.getCosto() + (producto.getCosto() * (datosGlobales.getPermisosUsr().getProteCost()/100));
